    ...
    captionWidget()
{
    ...
    ImageInterface *first_img = album->get_image();
    imageWidget.set(first_img->get_filename());
    ...
    captionWidget.set_text(first_img->get_caption().c_str());
...
{
    album->prev_image();
    ImageInterface *img = album->get_image();
    String caption = img->get_caption(); 
    imageWidget.set(img->get_filename());
    captionWidget.set_text(caption.c_str());
    caption.free_data();
}
